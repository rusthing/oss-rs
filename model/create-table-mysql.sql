...
(
   _id                  bigint unsigned not null  comment 'ID',
   name                 varchar(50) not null  comment '名称',
   remark               varchar(50)  comment '备注',
   _creator_id          bigint unsigned not null  comment '创建人的用户ID',
   _create_timestamp    bigint unsigned not null  comment '建立时间戳',
   _updator_id          bigint unsigned not null  comment '修改人的用户ID',
   _update_timestamp    bigint unsigned not null  comment '修改时间戳',
   primary key (_id),
...
(
   _id                  bigint unsigned not null  comment 'ID',
   is_completed         bool not null default true  comment '是否完成',
...
(
   _id                  bigint unsigned not null  comment 'ID',
   obj_id               bigint unsigned not null  comment '对象ID',
   bucket_id            bigint unsigned not null  comment '桶ID',
