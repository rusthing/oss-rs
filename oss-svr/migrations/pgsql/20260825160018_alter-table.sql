...
-- _create_timestamp -> create_ms
-- _updator_id     -> updator_id
-- _update_timestamp -> update_ms
...
ALTER TABLE oss_bucket RENAME COLUMN _create_timestamp TO create_ms;
ALTER TABLE oss_bucket RENAME COLUMN _updator_id TO updator_id;
ALTER TABLE oss_bucket RENAME COLUMN _update_timestamp TO update_ms;

-- 更新 oss_bucket 表的列注释
COMMENT ON COLUMN oss_bucket.id IS 'ID';
COMMENT ON COLUMN oss_bucket.creator_id IS '创建人的用户ID';
COMMENT ON COLUMN oss_bucket.create_ms IS '建立时间戳';
...
ALTER TABLE oss_obj RENAME COLUMN _create_timestamp TO create_ms;
ALTER TABLE oss_obj RENAME COLUMN _updator_id TO updator_id;
ALTER TABLE oss_obj RENAME COLUMN _update_timestamp TO update_ms;

-- 更新 oss_obj 表的列注释
COMMENT ON COLUMN oss_obj.id IS 'ID';
COMMENT ON COLUMN oss_obj.creator_id IS '创建人的用户ID';
COMMENT ON COLUMN oss_obj.create_ms IS '建立时间戳';
...
ALTER TABLE oss_obj_ref RENAME COLUMN _create_timestamp TO create_ms;
ALTER TABLE oss_obj_ref RENAME COLUMN _updator_id TO updator_id;
ALTER TABLE oss_obj_ref RENAME COLUMN _update_timestamp TO update_ms;

-- 更新 oss_obj_ref 表的列注释
COMMENT ON COLUMN oss_obj_ref.id IS 'ID';
COMMENT ON COLUMN oss_obj_ref.creator_id IS '创建人的用户ID';
COMMENT ON COLUMN oss_obj_ref.create_ms IS '建立时间戳';
