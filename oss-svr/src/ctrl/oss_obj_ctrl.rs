...
pub async fn add(
    ...
    let result = OssObjSvc::add::<DatabaseTransaction>(dto, None).await?;
...
pub async fn modify(
    ...
    let result = OssObjSvc::modify::<DatabaseTransaction>(dto, None).await?;
    Ok(HttpResponse::Ok().json(result))
}
...
pub async fn save(
    ...
    let result = OssObjSvc::save::<DatabaseTransaction>(dto, None).await?;
    Ok(HttpResponse::Ok().json(result))
}
...
pub async fn del(
    ...
    Ok(HttpResponse::Ok()
        .json(OssObjSvc::del::<DatabaseTransaction>(id, current_user_id, None).await?))
}
...
pub async fn get_by_id(
    ...
    let ro = OssObjSvc::get_by_id::<DatabaseConnection>(id, None).await?;
